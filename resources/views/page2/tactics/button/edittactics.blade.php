                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="#"><u>แก้ไขข้อมูลกลยุทธ์</u></a></li>
...
@endsection
@section('content')
<form action="{{route('edit_tactics_post')}}" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
    @csrf
    <div class="card">
