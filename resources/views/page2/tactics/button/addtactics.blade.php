...
@section('content')
    ...
    <form id="add_tactics_post" action="{{ route('add_tactics_post') }}" method="post" enctype="multipart/form-data" class="form-horizontal"
        autocomplete="off">
        @csrf
        <div class="card">
                        ...
                        <div class="row form-group row res_c">
                            ...
                            <div class="d-flex col-12 col-md-8">
                                <div class=""><input type="text" id="name-input" name="name_add"
                                        value="{{ old('name') }}" placeholder="กรอกชื่อกลยุทธ์" class="form-control">
                                    @error('name')
                                        <small class="help-block form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
