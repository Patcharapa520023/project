            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>ตารางแผนพัฒนาท้องถิ่นและกองการศึกษา</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">จัดการยุทธศาสตร์และกลยุทธ์</a></li>
                            <li><a href="http://127.0.0.1:8000/admin/year"><u>แผนพัฒนาท้องถิ่นและกองการศึกษา</u></a></li>
