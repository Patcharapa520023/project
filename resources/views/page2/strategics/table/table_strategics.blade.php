                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">จัดการข้อมูลปีงบประมาณ</a></li>
                            <li><a href="http://127.0.0.1:8000/admin/strategics#"><u>ยุทธศาตร์</u></a></li>
                        ...
                        <div class="card">
                            <div class="card-header d-flex p-2 justify-content-between align-items-center pl-4 pr-4">
                                    <strong class="card-title">ตารางข้อมูล</strong>
                                        <a class="addcus btn btn-outline-success" href="{{ route('add_strategics') }}">
                                            <i class="fa fa-plus"></i>&nbsp;เพิ่มข้อมูลยุทธศาสตร์
                                        </a>
                            </div>
                            <div class="card-body">
