                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="http://127.0.0.1:8000/admin/strategics#">บุคลากรสถานศึกษา</a></li>
...
@endsection
@section('content')
<form action="{{route('edit_strategics_post')}}" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
    @csrf
    <div class="card">
