                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="http://127.0.0.1:8000/admin/strategics#">ยุทธศาสตร์</a></li>
                                <li><a href="http://127.0.0.1:8000/admin/add/strategics"><u>เพิ่มข้อมูลยุทธศาตร์</u></a></li>
...
@endsection
@section('content')
    <form action="{{ route('add_strategics_post') }}" method="post" enctype="multipart/form-data" class="form-horizontal"
        autocomplete="off">
        @csrf
        <div class="card">
