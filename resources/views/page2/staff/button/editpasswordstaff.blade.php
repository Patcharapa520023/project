...
@endsection
@section('content')
<form action="{{route('editpassword_staff_post')}}" method="post" enctype="multipart/form-data" class="form-horizontal"  autocomplete="off">
    @csrf
    <div class="card">
            ...
            <div class="col-lg-6">
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input class="form-control" type="text" value="{{ $data->staff->title.$data->staff->name." ".$data->staff->lastname }}" name="" readonly>
                                @error('lastname')
                                <small class="help-block form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
